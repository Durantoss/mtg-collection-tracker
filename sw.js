...
const STATIC_FILES = [
  ...
  '/offline.html',
  // Enhanced CSS files
  '/theme-crimson-arcana.css',
  '/enhanced-mtg-card.css',
  '/enhanced-deck-builder.css',
  '/mobile-ui-enhanced.css',
  '/synergy-meter.css',
  '/mobile-fixes.css',
  '/mobile-phone-optimized.css',
  ...
  '/card-scanner.js',
  '/deck-builder.js',
  '/enhanced-deck-builder.js',
  '/deck-qr-integration.js',
  '/deck-history.js',
  '/swipeable-ui.js',
  '/deckforge.js',
  '/synergy-engine.js',
  '/synergy-meter-components.js',
  '/ar-gestures.js',
  '/ar-preview.js',
  '/mobile-ui-enhanced.js',
  '/mtg-card-component.js',
